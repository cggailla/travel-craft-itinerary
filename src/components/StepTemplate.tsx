    ...
    <>
      ...
      <div className="step-container mb-8 pb-6 border-b border-gray-200">
        ...
        {aiContent?.overview && !hiddenOverview && (
          <div className="mb-4 relative group">
            ...
            <button
              ...
              className="absolute top-0 right-0 text-gray-400 hover:text-gray-600 print:hidden"
                  ...
                  return (
                    <div key={segment.id} className="relative group">
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-1 space-y-0.5">
                            ...
                            {segment.address && (
                              <p className="text-xs text-gray-600">• Adresse : {segment.address}</p>
                            )}
                            
                            {segment.phone && (
                              <p className="text-xs text-gray-600">• Tél : {segment.phone}</p>
                            )}
                            ...
                            {segment.duration && (
                              <p className="text-xs text-gray-600">• Durée : {segment.duration}</p>
                            )}
                            
                            {endTime && startTime !== endTime && (
                              <p className="text-xs text-gray-600">• Arrivée : {endTime}</p>
                            )}
                          </div>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="absolute top-0 right-0 text-gray-400 hover:text-gray-600 opacity-0 group-hover:opacity-100 print:hidden"
                        aria-label="Supprimer"
                      >
                        ×
                      </button>
        ...
        {aiContent?.tips && aiContent.tips.length > 0 && !hiddenTips && (
          <div className="mt-4 pl-4 border-l-2 border-yellow-400 relative group">
        ...
        {aiContent?.localContext && !hiddenLocalContext && (
          <div className="mt-4 pl-4 border-l-2 border-green-400 relative group">
