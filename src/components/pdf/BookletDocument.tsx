...
export const Cover: React.FC<CoverProps> = ({ cover = {}, brand = {} }) => {
  ...
  const images: string[] = Array.isArray(cover.images)
    ? cover.images.slice(0, 2)
    : []
...
export const Itinerary: React.FC<ItineraryProps> = ({ itinerary = [], brand = {} }) => {
  const A5_HEIGHT_PT = 595
...
export const ThankYou: React.FC<ThankYouProps> = ({ thank = {}, brand }) => {
...
export const Emergency: React.FC<EmergencyProps> = ({ contact = {} }) => {
...
export const BookletDocument: React.FC<BookletDocumentProps> = ({ data }) => {
